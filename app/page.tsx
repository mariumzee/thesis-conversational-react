  ...
  return (
    <div className="flex flex-col h-screen">
      ...
      <div className="w-full bg-[#2f2f2f] flex justify-center items-center p-4 space-x-4">
        ...
        <SpeechComponent onTranscript={(transcript) => setInput(transcript)} />
        <Dialog open={openDialog}>
          ...
          <DialogContent style={{ backgroundColor: "#2f2f2f" }}>
            <DialogContentText style={{ color: "white" }}>
              ...
              influence future designs of search engines, potentially enhancing
              user interactions and satisfaction in digital environments. Our
              research team follows strict protocols to ensure ethical conduct,
              privacy protection, and consistent data collection across all
              observations.
              <br />
              <br />
              <strong>Purpose of the Study:</strong>
              This research seeks to explore the differences in user
              satisfaction and efficiency between conversational search engines
              and traditional search methods. The findings will help improve
              understanding of how search engine design can affect user
              experience.
              <br />
              <br />
              <strong>Nature of Involvement:</strong>
              As a participant in this study, you will be asked to interact with
              both conversational and traditional search interfaces and complete
              tasks that measure your efficiency and satisfaction. Each session
              is expected to last approximately 30 minutes maximum.
              <br />
              <br />
              <strong>Confidentiality:</strong>
              The confidentiality of your participation will be strictly
              maintained. We only require your age and occupational background.
              Pseudonyms will be used in any publications or presentations that
              result from this study to ensure that you cannot be identified.
              <br />
              <br />
              <strong>Additional Observations:</strong>
              In addition to standard data collection, we will record non-verbal
              cues such as signs of confusion, frustration, or engagement, and
              note any unusual behaviors during the study. These observations
              will help us gain insights into natural user responses without
              ...
              retention policies. We are committed to maintaining data integrity
              and will ensure that all information is handled responsibly.
              <br />
              <br />
            </DialogContentText>
          </DialogContent>
