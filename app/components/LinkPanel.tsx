...
const LinkPanel: React.FC<LinkPanelProps> = ({ messages, loading }) => {
  ...
  return (
    <div className="p-6 h-full overflow-y-auto link-panel">
            ...
            <div key={index} className={`message ${isUserMessage ? "user-message" : "gpt-message"}`}>
              <div className="message-box">
                ...
                <div className="message-content">
                  {isUserMessage ? msg.content : renderMessageContent(msg.content)}
                </div>
              </div>
            </div>
          );
      ...
      {loading && (<ThreeDots visible={loading} height="50" width="50" color="#b787f2" radius="9" ariaLabel="three-dots-loading" />)}
